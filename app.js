...
function createPopup(currentFeature) {
    ...
    const popup = new mapboxgl.Popup({ closeOnClick: true })
        ...
        .setHTML("<h3>" + '<a href="' + currentFeature.properties[config.popupInfo[3]] + '">' + currentFeature.properties[config.popupInfo[0]] + "</a>" + "</h3>" + "<br>" + currentFeature.properties[config.popupInfo[1]] + "<br>"  + currentFeature.properties[config.popupInfo[2]])
        .addTo(map);
}
