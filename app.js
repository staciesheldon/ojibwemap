...
function createPopup(currentFeature) {
    ...
    const popup = new mapboxgl.Popup({ closeOnClick: true })
        ...
        .setHTML("<h3>" + currentFeature.properties[config.popupInfo[0]] + "</h3>" + "<br>" + currentFeature.properties[config.popupInfo[1]] + "<br>"  + currentFeature.properties[config.popupInfo[2]] + currentFeature.properties[config.popupInfo[3]])
        .addTo(map);
}
