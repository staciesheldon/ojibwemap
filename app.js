...
function createPopup(currentFeature) {
    ...
    const popup = new mapboxgl.Popup({ closeOnClick: true })
        ...
        .setHTML("<h3>" + '<a href="' + currentFeature.properties[config.popupInfo[3]] + '" target="_blank" class="popupLink">' + currentFeature.properties[config.popupInfo[0]] + "</a>" + "</h3>" + "<br>" + currentFeature.properties[config.popupInfo[1]] + "<br clear="all /">"  + '<h5 class="addressPopup">' + currentFeature.properties[config.popupInfo[2]] + "</h5>")
        .addTo(map);
}
        ...
        csv2geojson.csv2geojson(csvData, {
            ...
            map.addLayer({
                ...
                "paint": {
                    ...
                    "circle-color": "#0DA989", // color of circles
                    "circle-stroke-color": "#BFEAE1",
